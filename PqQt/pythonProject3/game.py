...
#     choose = 3  # int(input('Если хотите играть с комрьютером введите 1, если с другом 2, с умным компьютером 3 '))
#
#     # Инициализация двух игроков
#     # if choose == 1 or choose == 3:
#     #     name_first_gamer = 'Бот>'
#     # elif choose == 2:
#     #     name_first_gamer = input('Игрок 1, введите Ваше имя: ')
#     # name_second_gamer = message.from_user.id
#     # await bot.send_message(f'Введите количество конфет: ')     #message.from_user.first_name
