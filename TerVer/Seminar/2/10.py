...
pu_238 = [0.126, 0.133, 0.127, 0.156, 0.503, 0.113, 0.129, 0.124, 1.022, 1.412, 1.533, 1.534, 1.437, 1.439, 1.375,
...
pu_239 = [75.804, 75.515, 75.175, 78.872, 73.317, 79.116, 75.751, 75.326, 63.287, 59.553, 58.688, 58.758, 59.728,
          59.544, 59.877, 61.182, 78.244, 78.166, 74.254, 79.840, 62.455, 73.189, 75.968, 75.957, 72.885,72.907,
...
pu_240 = [21.204, 21.408, 21.668, 18.428, 20.223, 18.548, 21.162, 21.557, 24.493, 25.576, 25.719, 25.692, 25.146,
          25.126, 25.128, 25.100, 18.488, 18.629, 21.515, 17.872, 24.656, 18.285, 20.794, 20.867, 21.718, 21.721,
          21.713, 20.225, 18.573, 18.633, 18.640, 18.869, 18.122, 20.750, 20.345, 19.108, 22.754, 23.320, 23.128,
          23.133, 23.239, 21.761, 21.429, 20.939, 23.603]
pu_241 = [2.180, 2.240, 2.305, 1.906, 4.128, 1.690, 2.260, 2.282, 6.990, 8.027, 8.279, 8.261, 8.377, 8.569, 8.428,
...
# print(scipy.stats.shapiro(pu_238))
# print(scipy.stats.shapiro(pu_239))
# print(scipy.stats.shapiro(pu_240))
# print(scipy.stats.shapiro(pu_241))
# print(scipy.stats.bartlett(pu_241, pu_240, pu_239, pu_238))
# print(scipy.stats.kruskal(pu_238, pu_239, pu_240, pu_241))
...
JJ_1 = np.array([0.71, 0.63, 0.85, 0.44, 0.61, 0.69, 0.92, 0.55, 0.72, 0.77, 0.92, 0.60, 0.83, 0.80, 1.00, 0.77, 0.92,
               1.00, 1.24, 1.00, 1.16 ])
JJ_2 = np.array([1.30, 1.45, 1.25, 1.26, 1.38, 1.86, 1.56, 1.53, 1.59, 1.83, 1.86, 1.53, 2.07, 2.34, 2.25, 2.16, 2.43,
               2.70, 2.25, 2.79, 3.42 ])
JJ_3 = np.array([3.69, 3.60, 3.60, 4.32, 4.32, 4.05, 4.86, 5.04, 5.04, 4.41, 5.58, 5.85, 6.57, 5.31, 6.03, 6.39, 6.93,
               5.85, 6.93, 7.74, 7.83])
JJ_4 = np.array([6.12, 7.74, 8.91, 8.28, 6.84, 9.54, 10.26, 9.54, 8.73, 11.88, 12.06, 12.15, 8.91, 14.04, 12.96, 14.85,
               9.99, 16.20, 14.67, 16.02, 11.61])
# print(scipy.stats.shapiro(JJ_1))
# print(scipy.stats.shapiro(JJ_2))
# print(scipy.stats.shapiro(JJ_3))
# print(scipy.stats.shapiro(JJ_4))
# print(scipy.stats.bartlett(JJ_4, JJ_1, JJ_3, JJ_2))
# print(scipy.stats.f_oneway(JJ_1, JJ_2, JJ_3, JJ_4))
#
...
# 2) alternative=‘less‘
# 3) 'two-sided'
before = [92.8, 95.6, 92.1, 100.6, 96.2, 92.1, 96.7, 97.6, 97.0, 93.9]
past = [87.1, 84.1, 81.3, 77.0, 86.0, 82.9, 83.0, 85.5, 85.2, 84.6]
# print(scipy.stats.ttest_rel(before, past, alternative="greater"))
# print(scipy.stats.ttest_rel(before, past, alternative="less"))
# print(scipy.stats.ttest_rel(before, past, alternative="two-sided"))
